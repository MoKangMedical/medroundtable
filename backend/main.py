...
from backend.routers import biomedical, rare_disease, health_mgmt, clinical_trials, literature, prediction, drug_database, evo_agent
...
# ============ 注册新路由 ============
app.include_router(rare_disease.router)
app.include_router(health_mgmt.router)
app.include_router(clinical_trials.router)
app.include_router(literature.router)
app.include_router(prediction.router)
app.include_router(drug_database.router)
app.include_router(evo_agent.router)
