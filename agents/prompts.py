...
DISCUSSION_STAGES = {
    "problem_presentation": {
        ...
        "prompt": """直接把问题压成可执行立项框架：
1. 用一句话写清研究对象、暴露/干预、主终点和时间窗
2. 说明本轮先要锁定的 3 个关键决策项
3. 指出最容易失败的风险点
4. 明确点名下一位专家要补什么交付物

不要再解释为什么值得研究，直接把题目收窄成可以继续推进的版本。"""
    },
...
2. 还未解决的缺口
3. 谁负责下一步交付
4. 是否允许按当前版本进入执行或文档整理

不要重复整段讨论史，只做最终判断和任务分配。"""
    }
}
