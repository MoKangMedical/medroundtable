(function () {
    const expertSkillBlueprints = {
        ...
        ai_data_engineer: { laneIds: ['data-fabric', 'ai-modeling', 'workflow-export'], sourcePackageIds: ['openclaw-medical-wrapper', 'ai-research-suite', 'medrt-enhanced-suite'], note: '更偏数据口径、结构整理、联接与下游模型管道。' },
