(function () {
    const expertSkillBlueprints = {
        clinical_director: { laneIds: ['evidence-synthesis', 'trial-design', 'quality-compliance', 'evidence-based-diagnosis'], sourcePackageIds: ['medrt-local-core', 'ai-research-suite', 'medrt-enhanced-suite'], note: '从题目判断、方案路径到诊断流程与发表门槛，适合作为首位临床总控入口。' },
        phd_student: { laneIds: ['evidence-synthesis', 'data-fabric'], sourcePackageIds: ['medrt-local-core', 'ai-research-suite'], note: '偏文献、证据和背景搭建，适合先补全研究现状与创新空白。' },
        ...
        ai_data_engineer: { laneIds: ['data-fabric', 'ai-modeling', 'workflow-export', 'evidence-based-diagnosis'], sourcePackageIds: ['openclaw-medical-wrapper', 'ai-research-suite', 'medrt-enhanced-suite'], note: '更偏数据口径、结构整理、联接、定量指标提取与下游模型管道。' },
        trend_researcher: { laneIds: ['evidence-synthesis', 'translational-drug'], sourcePackageIds: ['ai-research-suite', 'medrt-enhanced-suite'], note: '适合快速判断研究热点、竞品方向与投稿窗口。' },
